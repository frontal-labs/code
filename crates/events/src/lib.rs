...
mod tests {
    ...
    fn serializes_hosted_task_event_summary() {
        let summary = HostedTaskEventSummary {
            ...
            branch: Some("frontal-code/fix-flake".into()),
            published_branch: Some("frontal-code/fix-flake".into()),
        ...
        assert_eq!(serialized["branch"], "frontal-code/fix-flake");
        assert_eq!(serialized["published_branch"], "frontal-code/fix-flake");
        assert_eq!(
            serialized["pr_url"],
    ...
    fn renders_typescript_bindings_with_event_payloads() {
        ...
        assert!(bindings.contains("FrontalCodeGeneratedEventPayload"));
        assert!(bindings.contains("FrontalCodeGeneratedHostedTaskEventSummary"));
        assert!(bindings.contains("FrontalCodeGeneratedTerminalEventPayload"));
        assert!(bindings.contains("FrontalCodeGeneratedEventEnvelope"));
        assert!(bindings.contains("FrontalCodeGeneratedEventName"));
    }
}
