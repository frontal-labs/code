# Frontal Code Slack Bot Test Suite

This directory contains comprehensive tests for the Frontal Code Slack bot extension using Vitest.
...
|   `-- frontal-code-types.test.ts    # Frontal Code type definitions tests
|-- bot/
|   `-- slack-bot-service.test.ts # Main bot service tests
|-- services/
|   |-- frontal-code-api-client.test.ts   # Frontal Code API client tests
...
- **API Integration**: Test integration with external APIs (Frontal Code, Slack)
...
- **MSW Server**: Mock HTTP requests to Frontal Code API and Slack API
...
### Service Mocks
```typescript
// Mock Frontal Code API client
mockFrontalCodeApiClient.submitPrompt.mockResolvedValue({
  ok: true,
...
### Service Integration
- **Frontal Code API**: Prompt submission, status checks, health checks
...
This comprehensive test suite ensures the Frontal Code Slack bot is reliable, maintainable, and free of regressions.
