/**
 * Shared protocol types for the Frontal Code SDK.
 *
 * The SDK wraps the `frontal-code` CLI. The event names (`item.completed`,
...
/** Options for constructing the {@link Frontal Code} client. */
export interface FrontalCodeOptions {
  ...
  /** Path to the `frontal-code` CLI binary. Defaults to `"frontal-code"`. */
  command?: string;
}
